...
export function ResultsCalendar({
  ...
  const firstCandidateDate =
    dates.find((date) => byDate.has(date)) ??
    dates[0] ??
    "";

  const [selectedDate, setSelectedDate] =
    useState(firstCandidateDate);
  ...
  return (
    <div className="results-calendar-layout">
            ...
            <div className="calendar-grid">
              ...
              {month.dates.map((date) => {
                ...
                return (
                  <button
                    type="button"
                    className={`calendar-day result-day ${
                      selectedDate === date
                        ? "selected"
                        : ""
                    }`}
      ...
      <section className="result-day-detail">
        <div className="result-day-detail-heading">
          <span>
