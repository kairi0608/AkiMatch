...
export default function CreateSchedulePage() {
  ...
  const submit = (event: FormEvent) => {
    ...
    const schedule = scheduleRepository.createSchedule({ title: title.trim(), startDate, durationDays, dailyStartHour: startHour, dailyEndHour: endHour, requiredDurationHours: requiredHours });
  ...
  return <div className="create-shell">
    ...
    <form className="create-card" onSubmit={submit}>
      ...
      <div className="create-submit"><p>作成後、まずあなたの予定を入力します。</p><button className="btn" type="submit">日程調整を作成 <ArrowRight size={19} /></button></div>
    </form>
  </div>;
}
